...
const AboutInformations = () => (
  <div>
    <p>
      L&apos;Observatoire de la Démocratie est une initiative citoyenne élaborée par le{' '}
    ...
    <p>
      ...
      le mouvement La France Insoumise et son programme{' '}
      <a href="https://laec.fr/" rel="noopener noreferrer" target="_blank">
        l&apos;Avenir en Commun
      </a>
      .
      ...
      {' '}via leur service d&apos;Open Data ou via les comptes rendus de séance.
    ...
    <p>
      ...
      <br />
      Le travail de député•e requiert également de consacrer de nombreuses heures
      de travail avec des collaborateurs•trices, à analyser les textes de loi,
      rédiger des amendements et préparer différentes interventions. Enfin,
      les député•e•s sont amené•e•s à retourner régulièrement dans leur circonscription
      et participer à des événements publics.
    </p>
    <p>
      Nous tenons à mentionner que nous soutenons et remercions les initiatives du collectif{' '}
      <a href="https://www.regardscitoyens.org" rel="noopener noreferrer" target="_blank">
      Regards Citoyens
      </a>
      , notamment à travers les sites{' '}
      <a href="https://www.nosdeputes.fr/" rel="noopener noreferrer" target="_blank">
      nosdeputes.fr
      </a>
      {' '}et{' '}
      <a href="https://www.nossenateurs.fr/" rel="noopener noreferrer" target="_blank">
      nossenateurs.fr
      </a>
      {' '}qui nous ont inspiré dans l&apos;élaboration de cet outil.
    </p>
    <p>
      Si vous trouvez une erreur, un bug ou si vous souhaitez nous faire parvenir
      une remarque, envoyez-nous un e-mail à l&apos;adresse
      suivante&nbsp;:{' '}
      <a href="mailto:contact@observatoire-democratie.fr">
